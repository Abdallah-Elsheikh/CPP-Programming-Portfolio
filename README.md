...
| :--- | :--- | :--- |
| **`Student-Management-System.cpp`** | **File Handling & OOP** | A full CRUD system for managing student records. Utilizes `vectors` for dynamic storage and `fstream` for persisting data in external text files. |
...
| **`Pi-MonteCarlo-Simulation.cpp`** | **Algorithms** | An algorithmic simulation estimating the value of **PI** using the **Monte Carlo method**, showcasing mathematical modeling and random sampling. |
